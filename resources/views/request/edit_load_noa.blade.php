<div class="row">
  <div class="col s10 m5">
    ...
    <div class="row">
      <div class="input-field col s12">
        <input name="turnover_date" type="text" class="validate" value=""><!-- {{ date('M d, Y', strtotime(trim($details->rfc_turnover))) }} -->
  ...
  <div class="col s10 m5 padding-left-25 hide-on-small-only">
    ...
    <div class="row">
      <div class="input-field col s12">
        <input name="noa_number" type="text" class="validate" value="{{ $details->rfc_noa }}">
        <label for="noa_number">NOA Number</label>
      </div>
    </div>
    <div class="row">
      <div class="input-field col s12">
        <input name="contractor" type="text" class="validate" value="{{ $details->con_code }}">
